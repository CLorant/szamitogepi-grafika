...
{
    bool left_x = pong->ball.x - pong->ball.radius < 50;
    bool left_y = pong->ball.y - pong->ball.radius < 0;
    bool right_x = pong->ball.x + pong->ball.radius > pong->width - 50;
    bool right_y = pong->ball.y + pong->ball.radius > pong->height;
